    ...
    <div className="min-h-screen flex flex-col">
      <header className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm text-muted-foreground"> Desenvolvido com 💙 no NWL da RocketSeat </span>
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-small text-muted-foreground">
            Lembre-se: você pode utilizar a variável <code className="text-primary">{'{transcription}'}</code>
        ...
        <aside className="w-80 space-y-6">
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <Slider min={0} max={1} step={0.1} defaultValue={[0.5]}></Slider>
              <span className="block text-xs text-muted-foreground italic">
